...
namespace customfield_apsolu_course_type;
...
class field_controller extends \core_customfield\field_controller {
    ...
    public function config_form_definition(\MoodleQuickForm $mform) {
        ...
        $mform->addElement(
            ...
            get_string('default_field_settings', 'customfield_apsolu_course_type')
        );
    ...
    public function config_form_validation(array $data, $files = []): array {
        ...
        if (isset($options[$defaultvalue]) === false) {
            $errors['configdata[defaultvalue]'] = get_string('the_selected_value_is_invalid', 'customfield_apsolu_course_type');
        }
    ...
    public function get_options(): array {
        ...
        foreach (Coursetype::get_records($conditions = null, $sort = 'name') as $option) {
